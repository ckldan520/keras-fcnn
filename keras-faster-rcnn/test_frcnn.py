...
#C.model_path = '../FRCNN/model_A.hdf5'
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
    ...
    #
	# #		textLabel = '{}: {}%'.format(key,round(100 * new_probs[jk], 1)) #tiansheng
	...
	if len(temp_bbox) == 0:
		...
		print('None')
		continue
	new_boxes, new_probs, pick = roi_helpers.non_max_suppression_tiansheng(np.array(temp_bbox), np.array(temp_prob), overlap_thresh=0.1)
